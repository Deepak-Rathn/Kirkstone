...
{
	return mlt_malloc(size, __builtin_return_address(1), file, line);
}
...
{
	mlt_free(p, __builtin_return_address(1), file, line);
}

void * rpl_realloc0 (void *p, unsigned int size, const char *file, int line)
{
	return mlt_realloc(p, size, __builtin_return_address(0), file, line);
}

void * rpl_realloc1 (void *p, unsigned int size, const char *file, int line)
{
	return mlt_realloc(p, size, __builtin_return_address(1), file, line);
}

void * rpl_calloc0 (unsigned int num, unsigned int size, const char *file, int line)
{
	return mlt_calloc(num, size, __builtin_return_address(0), file, line);
}

void * rpl_calloc1 (unsigned int num, unsigned int size, const char *file, int line)
{
	return mlt_calloc(num, size, __builtin_return_address(1), file, line);
}

char * rpl_strdup(const char *str, const char *file, int line)
{
	return mlt_strdup(str, __builtin_return_address(0), file, line);
}
